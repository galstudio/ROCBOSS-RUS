            ...
            <div class="topic-url">
                ...
                <span class="post-tagline">
                    {if isset($t['istop']) && $t['istop'] > 0}
                        <span class="toping" title="Прикрепить"><i class="icon icon-locationfill x1"></i></span>
                    {/if}
                    {if isset($t['pictures']) && $t['pictures'] != array() }
                        <span class="picturing" title="Открепить"><i class="icon icon-camerafill x1"></i></span>
                    {/if}
