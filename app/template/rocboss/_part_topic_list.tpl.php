...
<ul>
    ...
    <li class="topic-item">
        <div class="posts-group cf">
            <div class="upvote ">
                <a class="upvote-link vote-up" href="{$root}read/{$t.tid}" title="В избранном у {$t.praiseArray.count} пользователей">
            ...
            <div class="topic-url">
                ...
                <span class="post-tagline">
                    {if isset($t['istop']) && $t['istop'] > 0}
                        <span class="toping" title="Прикреплен"><i class="icon icon-locationfill x1"></i></span>
                    {/if}
                    {if isset($t['hasPictures']) && $t['hasPictures'] == true }
                        <span class="picturing" title="Изображение"><i class="icon icon-camerafill x1"></i></span>
                    {/if}
                    {if $t['tagArray'] != array()}
            ...
            <ul class="topic-meta right">
                <li class="topic-avatar">
                    ...
                    <div class="user-tooltip">
                        ...
                        {if $t['signature'] != ''}
                        <h4 class="user-title">Подпись: {$t.signature}</h4>
                        {/if}
                        <p class="user-bio">{$t.posttime}</p>
                        {if $t['client'] != ''}
                        <p class="user-client">
                            （ОС: {$t.client}）
                        </p>
