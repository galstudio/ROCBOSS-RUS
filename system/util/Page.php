...
class Page
{
    ...
    public function up_page($name = 'Назад')
    {
        if ($this->now_page != 1)
        {
    ...
    public function down_page($name = 'Далее')
    {
    ...
    protected function show_3()
    {
        ...
        $begin  = ($begin >= 1) ? $begin : 1;
        $return = 'Всего ' . $this->total_rows . ' Разбить на ' . $this->total_pages . ' Текущая ' . $this->now_page . ' Страница ';
        $return .= ',На страницу ';
